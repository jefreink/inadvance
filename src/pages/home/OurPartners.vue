<template>
    <div class="w-full  px-4">
        <div class="flex flex-col container md:mx-auto lg:px-12">
            <div class="font-primary flex flex-col px-4 py-12 md:py-20 w-full items-center md:w-full  md:ml-auto ">
                <div class=" text-secondary text-4xl md:text-5xl pb-4 text-center w-full md:max-w-full ">
...
export default {
    ...
    computed: {
        title_1() {
            return this.$store.getters['lang/texts']['home']['our_partners']['title_1'];
        },
        title_2() {
            return this.$store.getters['lang/texts']['home']['our_partners']['title_2'];
        },
        slides() {
            return this.$store.getters['lang/texts']['home']['our_partners']['slides'];
        },
    },
};
</script>
