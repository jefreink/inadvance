<template>
  <div id="success-stories-home" class="w-full bg-white ">
            ...
            >
              ...
              >
                <div class="">
                  ...
                  <div class="font-primary text-primary font- text-base">
                    {{ checkText(item.text) }}
                  </div>
                  <div class="flex flex-row items-center py-6 cursor-pointer">
                    <div
                      id="read-more"
